...
app = Flask(__name__)
CORS(app)  # ← Esto permite llamadas desde el navegador (CORS)

API_KEY = os.environ.get("API_KEY", "lucia2025")
...
def home():
    return jsonify({
        "nombre": "Lucía API",
        "estado": "operativa",
        "endpoints_disponibles": ["/ping", "/registrar (POST)", "/leer (GET)", "/panel (GET)"],
